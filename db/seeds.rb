...
m = Movie.find_by(title: "Iron Man")

m.reviews.create!([
  {
    name: "Dave Rees",
    stars: 4,
    comment: "I had a lot of fun",
    location: "Hampshire, ENG"
  },
  {
    name: "John Rees",
    stars: 3,
    comment: "Well it was interesting",
    location: "Chicago, IO"
  },
])

m = Movie.find_by(title: "Superman")

m.reviews.create!([
  {
    name: "Chas Michaels",
    stars: 4,
    comment: "It doesn't get much better than this",
